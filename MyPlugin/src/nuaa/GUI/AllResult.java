...
//    private Object[] columnNames = {"", "核心一", "核心二", "核心三","内存路径一","内存路径二"};
    ...
    public AllResult(SystemInstanceImpl SystemInstanceImpl) {
    	...
    	Core core=new Core();
    	String[] c=core.coreArray(SystemInstanceImpl);
    	int coreNum=core.coreNum();
    	String name=core.processorName();
    	System.out.print(name);
    	Threads task=new Threads();
    	ThreadImplementationImpl[] threadArray=task.threadArray(SystemInstanceImpl);
