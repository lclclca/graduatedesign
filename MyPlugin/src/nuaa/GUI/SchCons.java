...
public class SchCons extends JPanel {

    public SchCons() throws HeadlessException {
        ...
        add(panel1);
        ImageIcon bg1=new ImageIcon("C:\\images\\schpara.png");
        JLabel label1=new JLabel(bg1);
        label1.setBorder(BorderFactory.createEtchedBorder());
        panel1.add(label1);
        //决策变量面板
        ImageIcon bg2=new ImageIcon("C:\\images\\schdecide.png");
        JLabel label2=new JLabel(bg2);
        JScrollPane panel2=new JScrollPane(label2,ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER,ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        add(panel2);
        //约束面板
        ImageIcon bg3=new ImageIcon("C:\\images\\schcons.png");
        JLabel label3=new JLabel(bg3);
        JScrollPane panel3=new JScrollPane(label3,ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        panel3.getVerticalScrollBar().setUI(new BEScrollBarUI());
        panel3.getHorizontalScrollBar().setUI(new BEScrollBarUI());
        panel3.setBounds(420,110,470,300);
        panel3.setBackground(Color.white);
        panel3.setBorder(BorderFactory.createTitledBorder("约束公式"));
        add(panel3);
        //目标函数
        ImageIcon bg4=new ImageIcon("C:\\images\\schobj.png");
